...
<Button
	...
	{builders}
	class={cn(
		'flex items-center gap-1.5 h-7 py-1 px-2 text-muted-foreground hover:text-black border-dashed rounded-full data-[state=open]:border-solid',
...
>
	...
	{#if $filterValues[valueName]}
		...
		<span class="text-xs text-primary">{preview}</span>
	{/if}
</Button>
